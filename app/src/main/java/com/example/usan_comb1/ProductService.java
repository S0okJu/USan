...
public interface ProductService {
    ...
    @GET("/product/check/{username}/{chatId}")
    Call<CheckRoleResponse> getRole(@Header("Authorization") String accessToken, @Part("username") String username, @Path("chatId") String chatId);
    /*
