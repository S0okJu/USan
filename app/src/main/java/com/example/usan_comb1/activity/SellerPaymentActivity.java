...
* */
    ...
    private void checkPaymentAct() {
        ...
        payRef.child(chatId).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (sellerStatus != null && buyerStatus != null && sellerStatus && buyerStatus) {
                    ...
                    Intent intent = new Intent(SellerPaymentActivity.this, PaymentFailActivity.class);
                    startActivity(intent);
                }
            }
